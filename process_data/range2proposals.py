import sys
sys.path.append('depth_cluster/lib')
import segment
...
def read_data(calib_path,range_path,ranges,idx):
...
def main(root):
    ...
    for seg_file in segs:
        ...
        for idx in range(len(ranges)):
            data,img_np,cp = read_data(calib_path,range_path,ranges,idx)
            # generate proposal
...
if __name__ == "__main__":
    ...
    parser.add_argument('--root',default='/scratch/ag7644/waymo_sf_debug11/',help='path for the data processed')
